	...
	<div class="row justify-content-center">
		...
		<div class="col-lg-12">
			<div class="white-box analytics-info">
				...
				<?php echo form_open( base_url() . 'config/parts/delete/' . $part['id'])?>
				<input type="hidden" name="id" value="<?php echo $part['id'] ?>">
				<div class="row mt-5">
					<div class="col-3">
						<label for="">Part Number</label>
						<input id="reason-downtime" name="part_no" type="text" class="form-control" value="<?php echo $part['COL1'] ?>" readonly>
					</div>
					<div class="col-3">
						<label for="">Part Description</label>
						<input id="reason-downtime" name="description" type="text" class="form-control" value="<?php echo $part['COL2'] ?>" readonly>
					</div>
					<div class="col-3">
						<label for="">Machine</label>
						<select name="machine" class="form-control" disabled>
					...
					<div class="col-3">
						...
						<input  name="pph" type="number" step="1"  min="1"  class="form-control" value="<?php echo $part['COL4'] ?>" disabled>
					</div>
