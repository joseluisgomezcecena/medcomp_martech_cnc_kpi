	...
	<div class="row justify-content-center">
		...
		<div class="col-lg-12">
			<div class="white-box analytics-info">
				...
				<?php echo form_open( base_url() . 'config/downtimes/edit/' . $downtime['dt_id'] )?>
				<input type="hidden" name="dt_id" value="<?php echo $downtime['dt_id'] ?>">
				<div class="row mt-5">
					<div class="col-3">
						<label for="">Downtime Reason</label>
						<input id="reason-downtime" name="dt_reason" type="text" class="form-control" value="<?php echo $downtime['dt_reason']; ?>" required>
					</div>
					<div class="col-12 mt-5">
						<input type="submit" class="btn btn-outline-primary" value="Update Downtime">
					</div>
				</div>
				<?php echo form_close()?>
			</div>
