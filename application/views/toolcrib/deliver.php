<div class="page-breadcrumb bg-white">
	<div class="row align-items-center">
		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
			<h4 class="page-title">Entrega de insertos para SUP: <span class="text-primary"><?php echo $request['boy_sup'] ?></span></h4>
		</div>
	...
	<div class="row justify-content-center">
		<div class="col-lg-12 col-md-12">
			...
			<div class="white-box analytics-info">
				<?php echo form_open('toolcribs/deliver') ?>


				<h3 class="box-title">ENTREGA DE TOOLING LIST PLUS E INSERTOS</h3>
				...
				<div class="row mt-4">
					<div class="form-group col-6">
						...
						<input type="text" class="form-control" name="pickup_by" required>
					...
					<div class="form-group col-6">
						...
						<input type="text" class="form-control" name="delivered_by" required>
						<small class="text-danger">* Campo requerido</small>
				...
				<div class="row">
					<div class="col-lg-12">
						...
						<input class="btn btn-primary" type="submit" value="Molde Entregado">
					</div>
				</div>
