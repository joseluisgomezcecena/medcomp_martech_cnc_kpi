<div class="page-breadcrumb bg-white">
	<div class="row align-items-center">
		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
			<h4 class="page-title">Actualizar SUP <?php echo strtoupper($sup['boy_sup']); ?>.</h4>
		</div>
		<div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
			<div class="d-md-flex">
				<ol class="breadcrumb ms-auto">
					<li><a href="#" class="fw-normal">Actualizar SUP</a></li>
				</ol>
			</div>
		</div>
	</div>
		...
		<div class="col-lg-12 col-md-12">
			...
			<?php if($this->session->flashdata('updated')): ?>
				...
				<div class="alert alert-warning alert-dismissible fade show" role="alert">
					<strong class="uppercase"><bdi>SUP Actualizado</bdi></strong>
			...
			<div class="white-box analytics-info">
				<?php echo form_open('engineeringforms/update') ?>
